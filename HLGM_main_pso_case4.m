...
% Case 4: Foundation subsidence of some coastal highway is predicted.
...
p = 6;  % Sample size
M = [3.3	5.6	7.9	10.3	14.5	18.1	23.8	28.6]'; % Original non-negative observation sequence
pf = 2; % Out of sample predictions
ph = p+2-pf; % Training sets
error_style='MAPE';
[mape,M0_hat,a,b,mape_all]=HLGM([-0.263835688	0.597659633]); % case3
